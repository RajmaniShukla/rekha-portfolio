...
import { Globe2, GraduationCap, Heart } from "lucide-react";
        ...
        <div className="container-wide">
          ...
          >
            <motion.div variants={fadeInLeft} className="space-y-6">
              ...
              <p className="text-brand-navy/70 leading-relaxed">
                Each role taught me something new about people, markets, and what it
                truly takes to grow a business. I speak 6+ languages fluently, which
                gives me a rare ability to connect across cultures and demographics.
              </p>
              <p className="text-brand-navy/70 leading-relaxed">
            ...
            <motion.div variants={fadeInRight} className="bg-brand-navy rounded-3xl p-10 text-white space-y-6">
              ...
              <p className="text-white/50 text-sm">
                Proficient in 7 languages — a key advantage in diverse Indian markets.
              </p>
            </motion.div>
          </motion.div>
        </div>
          ...
          >
            <motion.div variants={fadeInUp}>
              <div className="section-tag mb-4">
                <div className="gold-line" /> Education
              </div>
              <h2 className="font-display text-4xl font-bold text-brand-navy">
