    ...
    <main className="pt-20">
      ...
      <section className="section-padding bg-brand-blush">
        <div className="container-wide max-w-4xl">
          ...
          >
            {/* Resume placeholder — replace with PDF embed or styled resume */}
            <div className="p-8 md:p-12 space-y-8">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["Sales Strategy", "Team Leadership", "Digital Marketing", "CPC · RPM · VCPM", "Inventory Management", "CRM Software", "Client Relations", "B2B · B2C"].map((s) => (
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["English", "Hindi", "Kannada", "Telugu", "Tamil", "Oriya", "Bengali"].map((l) => (
